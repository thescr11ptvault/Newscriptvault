...
local Window = Rayfield:CreateWindow({
   Name = "99 Nights In The Forest - By Scriptvault",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "99 Nights In The Forest",
   LoadingSubtitle = "Script By ScriptVault",
   ...
   Discord = {
      ...
      Invite = "Fw9nmwQYhY", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
